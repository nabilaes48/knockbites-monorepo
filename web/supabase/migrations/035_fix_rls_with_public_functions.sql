-- =====================================================
-- Migration 035: Fix RLS Infinite Recursion (Public Schema)
-- Version: 1.0
-- Date: 2025-11-20
-- Purpose: Fix infinite recursion using PUBLIC schema functions
-- =====================================================

-- =====================================================
-- STEP 1: Create helper functions in PUBLIC schema (SECURITY DEFINER)
-- =====================================================
...
-- Function to get current user's assigned stores
...
-- Also drop any policies from migration 034 if they exist
...
-- =====================================================
-- SUCCESS! RLS policies fixed using PUBLIC schema.
--
-- Changes:
-- ✅ Added SECURITY DEFINER functions in PUBLIC schema
-- ✅ Removed recursive queries from policies
-- ✅ Simplified policy logic
-- ✅ Users can now login without infinite recursion
-- ✅ No special permissions required (uses public schema)
-- =====================================================
