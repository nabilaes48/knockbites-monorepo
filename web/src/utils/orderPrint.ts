...
/**
 * Play a loud notification sound for new orders
 */
export function playNewOrderSound(): void {
  try {
    ...
    // Play a sequence of tones that sound like a bell/ring
    ...
    // Ring pattern: ding-ding-ding (3 times)
    // First ring
    playTone(880, now, 0.15, 0.5);
    playTone(1100, now + 0.15, 0.15, 0.4);

    // Second ring
    playTone(880, now + 0.4, 0.15, 0.5);
    playTone(1100, now + 0.55, 0.15, 0.4);

    // Third ring
    playTone(880, now + 0.8, 0.15, 0.5);
    playTone(1100, now + 0.95, 0.15, 0.4);

    // Final flourish
    playTone(1320, now + 1.2, 0.3, 0.3);
