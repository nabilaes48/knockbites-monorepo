-- =====================================================
-- User Profile System Migration (NO FOREIGN KEYS)
-- Version: 2.5 - Just get it working first
-- Date: 2025-11-19
-- =====================================================
...
-- NO FOREIGN KEY TO STORES - Just store the ID as INT
-- =====================================================
...
-- The default_store_id column exists and can store store IDs
-- No foreign key constraint - just stores the INT value
-- =====================================================
