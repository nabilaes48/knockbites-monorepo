-- =====================================================
-- User Profile System Migration (FINAL)
-- Version: 2.7 - Completely Safe
-- Date: 2025-11-19
-- =====================================================
...
CREATE TABLE user_profiles (
    ...
    -- App Preferences - links to stores(id)
...
CREATE INDEX idx_user_profiles_store ON user_profiles(default_store_id);
...
-- ✅ user_profiles - Store dietary prefs & default_store_id
--
-- The default_store_id column links to stores(id) for order numbering
-- =====================================================
