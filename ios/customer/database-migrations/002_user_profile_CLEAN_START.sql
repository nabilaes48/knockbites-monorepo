-- =====================================================
-- User Profile System Migration (CLEAN START)
-- Version: 2.6 - Drop and Recreate Everything
-- Date: 2025-11-19
-- =====================================================
...
--
-- Tables created:
-- - user_favorites (links to menu_item_id)
-- - user_addresses (delivery addresses)
-- - user_profiles (links to stores(id) via default_store_id)
-- =====================================================
