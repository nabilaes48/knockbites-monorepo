-- =====================================================
-- Customer App Profile System
-- Version: 3.0 - Final Clean Separation
-- Date: 2025-11-19
-- Note: Separate customers table from user_profiles (business)
-- =====================================================

-- =====================================================
-- STEP 1: Clean up old customer tables
-- =====================================================
DROP TABLE IF EXISTS customer_favorites CASCADE;
DROP TABLE IF EXISTS customer_addresses CASCADE;

-- =====================================================
-- STEP 2: Add columns to existing customers table
-- =====================================================
...
-- =====================================================
-- STEP 3: Create customer_favorites table
-- =====================================================
...
-- =====================================================
-- STEP 6: Create RLS Policies for customer_favorites
-- =====================================================
...
-- =====================================================
-- STEP 7: Create RLS Policies for customer_addresses
-- =====================================================
...
-- =====================================================
-- STEP 9: Create helper functions for customers
-- =====================================================
...
--
-- Created:
-- ✅ customer_favorites - Store favorite menu items (separate from business)
-- ✅ customer_addresses - Store delivery addresses (separate from business)
--
-- Security:
